// type for objects used with the Spotify Web API
...
export type Disallows = { disallows: Partial<Record<Objects, boolean>> };
...
export type ExternalID = { [key: string]: string };

export type ExternalURL = { [key: string]: string };
...
/* parameter for Get Recommendations endpoint */
export type RecommendationsSeeds = {
  seed_artists?: string[];
  seed_genres?: string[];
  seed_tracks?: string[];
};
...
export type ReorderPlaylistItems = {
  range_start: number;
...
export type ReplacePlaylistItems = { uris: string[] };
...
export type Restrictions = { reason: string };
...
export type VideoThumbnail = { url: string | null };
